...
<body class="bg-gradient-to-br from-gray-900 to-gray-800 min-h-screen text-gray-100">
    ...
    <section class="flex items-center justify-center min-h-screen px-4">
        <div class="backdrop-blur-lg bg-gray-800/50 rounded-xl border border-gray-700 p-8 max-w-md w-full">
            <h2 class="text-2xl font-bold text-violet-300 mb-6">Welcome Back</h2>
            ...
            <form class="space-y-6" action="controllers/process_signin.php" method="POST">
                <div class="form-group">
                    <label for="email" class="block text-gray-300 mb-2">Email</label>
                    <input type="email" 
                           id="email" 
                           name="email" 
                           class="w-full bg-gray-900/50 border border-gray-700 rounded-lg py-2 px-4 text-gray-100 placeholder-gray-500 focus:border-violet-500 focus:ring-violet-500 focus:ring-1" 
                           required>
                </div>
                ...
                <p class="text-center text-gray-400 mt-4">
                    ...
                    <a href="<?php echo BASE_URL ?>/signup.php" class="text-violet-400 hover:text-violet-300 transition-colors">
                        Sign Up
                    </a>
                </p>
            </form>
